...
Sequelize.prototype.insertCLOB = function(model, data, primaryKey, ClobFields,table_name, done) {
    ...
    model
        ...
        .then(function(result) {
            ...
            let tbName = model.options.name["plural"];
            table.push(tbName);
            ...
            _this.connectionManager.getConnection(_this.config).then(function(connection) {
                console.log("\n\nreturning.params:",returning.params);
                console.log("\n\nwhere",where);
                ...
                connection.execute(
                    ...
                    function(err, result) {
                        ...
                        async.forEachOfLimit(ClobData, 5, function(value, key, nextKey) {
                            ...
                            console.log("\n\nresult.outBinds[key]:",result.outBinds[key]);
                            ...
                            if (err) {
                                ...
                                connection.commit(function(err) {
                                    ...
                                    connection.release(function(err) {
                                        setImmediate(() => done(err, data,search[primaryKey]));
                                    });
